...
class StyxModels:
  model_map = {
    ...
    "Llama 3.1 70B" : "https://meta-llama-3-1-70b-instruct-styx.westus.models.ai.azure.com/chat/completions",
    "Llama 3.1 8B" : "https://Meta-Llama-3-1-8B-Instruct-styx1.westus.models.ai.azure.com/chat/completions"
  }
  model = None
